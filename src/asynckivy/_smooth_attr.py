...
class smooth_attr:
    '''
    Make an attribute smoothly follow another.
    ...
    .. code-block::
        ...
        # 'obj.xx' will smoothly follow 'widget.x' permanently.
    ...
    The ``target`` parameter must be a numeric or numeric sequence type property,
    ...
    * :class:`~kivy.properties.ColorProperty`
    ...
    :param min_diff: If the difference between the target and the follower is less than this value, the follower
        will stop following the target and instantly jump to the target's value. When the target is a
        ``ColorProperty``, you most likely want to set this to a very small value, such as 0.01.
        Defaults to ``dp(2)``.
