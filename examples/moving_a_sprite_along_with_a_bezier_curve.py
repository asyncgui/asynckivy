...
class SampleApp(App):
    ...
    async def play_animation(self, *, draw_target, speed=1.0):
        ...
        try:
            ...
            await ak.anim_attrs(color_inst2, a=1.0, duration=0.5 / speed)
            await slp()

            # Make the above two darker.
            group1.remove(color_inst2)
            await ak.anim_attrs(color_inst1, r=0.3, g=0.3, b=0.3, duration=0.5 / speed)
            ...
            await slp()
            await ak.wait_all(
                ak.anim_attrs(color_inst1, a=0, duration=0.5 / speed),
                ak.anim_attrs(color_inst3, r=0.3, g=0.3, b=0.3, duration=0.4 / speed),
            )
